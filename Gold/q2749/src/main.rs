...
fn mmul_2x2 (matrix1 : Vec<Vec<u128>>, matrix2 : Vec<Vec<u128>>) -> Vec<Vec<u128>> {
    ...
    result[0][0] = matrix1[0][0]*matrix2[0][0] % 1000000 + matrix1[0][1]*matrix2[1][0] % 1000000;
    result[0][1] = matrix1[0][0]*matrix2[0][1] % 1000000 + matrix1[0][1]*matrix2[1][1] % 1000000;
    result[1][0] = matrix1[0][0]*matrix2[1][0] % 1000000 + matrix1[1][0]*matrix2[1][1] % 1000000;
    result[1][1] = matrix1[0][1]*matrix2[1][0] % 1000000 + matrix1[1][1]*matrix2[1][1] % 1000000;
...
fn main() {
    ...
    write!(out,"{}",fpow(f1, num)[0][1] % 1000000).unwrap();
}